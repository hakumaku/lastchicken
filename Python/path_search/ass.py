    ...
    def __nearest_search(self):
        ...
        while True:
            ...
            for next_point in points:
                next_point.distance = p.distance + 1
                md = self._Maze__manhattan_distance(next_point)
                prior = md + next_point.distance
